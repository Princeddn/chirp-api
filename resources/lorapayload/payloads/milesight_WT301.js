/**
 * 
 * https://github.com/Milesight-IoT/SensorDecoders/blob/main/WT_Series/WT30x/WT30x_Decoder.js
 * Payload Decoder
 *
...
function milesightDeviceDecode(bytes) {
    ...
    switch (data_id) {
        case 0x01:
            decoded.thermostat_status = bytes[i + 5] === 1 ? 1 : 0;
            break;
        case 0x02:
            decoded.btn_lock_enabled = bytes[i + 5] === 1 ? 1 : 0;
            break;
        case 0x03:
        ...
        case 0x0f:
            decoded.thermostat_status = bytes[i + 5] === 1 ? 1 : 0;
            decoded.btn_lock_enabled = bytes[i + 6] === 1 ? 1 : 0;
