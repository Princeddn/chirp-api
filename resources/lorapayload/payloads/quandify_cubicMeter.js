// https://github.com/akenza-io/device-type-library/blob/468feceeeb434ad3100d3aadc8c00ed8d12c2c71/types/quandify/cubicmeter-1.1-copper/uplink.js
...
const appStates = {
  ...
  const statusReportDecoder = function (data) {
	...
	const decoded = {
	  ...
	  leakState: camelToSnakeCase(leakStates[data.getUint8(22)] ?? "noLeak"),
