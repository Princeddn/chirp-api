/**
 * 
 * https://github.com/Milesight-IoT/SensorDecoders/blob/main/TS_Series/TS30x/TS30x_Decoder.js
 * Payload Decoder
 *
...
function milesightDeviceDecode(bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // MAGNET STATUS(CHANNEL 1 SENSOR)
            ...
            decoded.magnet_chn1 = bytes[i] === 0 ? 0 : 1;
            i += 1;
        }
        ...
        // MAGNET STATUS(CHANNEL 2 SENSOR)
            ...
            decoded.magnet_chn2 = bytes[i] === 0 ? 0 : 1;
            i += 1;
        }
