/* https://github.com/dragino/dragino-end-node-decoder/blob/main/CPL03-LB/CPL03-LB_TTN_v1.1.1_decoder.txt */
function datalog(i,bytes){
  ...
  function Decode(input) {
    ...
    { 
      ...
      var tdc_interval=(bytes[0]&0x10)?"1":"0";   
      var ttrig_mod=(bytes[0]&0x04)>>2; 
      var alarm=(bytes[0]&0x02)?"1":"0"; 
      var pin_status=(bytes[0]&0x01)?"0":"1";  
      ...
      var pa8_roc_flag=(bytes[10]&0x01)?"1":"0";
      var pa4_roc_flag=(bytes[10]&0x02)?"1":"0";
      var pb15_roc_flag=(bytes[10]&0x04)?"1":"0";
