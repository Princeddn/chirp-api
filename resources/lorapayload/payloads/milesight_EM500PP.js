...
function handle_downlink_response(channel_type, bytes, offset) {
    ...
    switch (channel_type) {
        ...
        case 0x06:
            ...
            // pressure alarm
            if (id === 1) {
                decoded.pressure_alarm_config = {};
                decoded.pressure_alarm_config.enable = readEnableStatus(enable);
                decoded.pressure_alarm_config.condition = readConditionType(condition);
                decoded.pressure_alarm_config.threshold_min = readInt16LE(bytes.slice(offset + 1, offset + 3));
                decoded.pressure_alarm_config.threshold_max = readInt16LE(bytes.slice(offset + 3, offset + 5));
                decoded.pressure_alarm_config.alarm_release_enable = readEnableStatus(alarm_release_enable);
            }
            offset += 9;
            break;
        case 0x10:
        ...
        case 0xf1:
            ...
            decoded.pressure_calibration_settings.calibration_value = readInt16LE(bytes.slice(offset + 2, offset + 4));
            offset += 4;
            break;
        case 0xf2:
 ...
 * @example { "pressure_alarm_config": { "enable": 1, "condition": 2, "threshold_min": 0, "threshold_max": 0, "alarm_release_enable": 1 } }
 */
