// https://github.com/dragino/dragino-end-node-decoder/blob/main/AQS01-L/AQS01-L_V1.3_ChirpstackV4_decoder.txt
...
function Decode(input) {
  ...
  if(port==0x02)
  {
    ...
    decode.TEMPL_flag= (bytes[10] &0x08)? "1":"0";
    decode.TEMPH_flag= (bytes[10] &0x04)? "1":"0";
    decode.CO2L_flag= (bytes[10] &0x02)? "1":"0";
    decode.CO2H_flag= (bytes[10] &0x01)? "1":"0"; 
