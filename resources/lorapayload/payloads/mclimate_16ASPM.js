/* https://docs.mclimate.eu/mclimate-lorawan-devices/devices/mclimate-16a-switch-and-power-meter-lorawan-16aspm/mclimate-16aspm-uplink-decoder */
function Decode(input) {
    try {
        ...
        // Relay state
        data.relayState = bytes[11] === 0x01 ? 1 : 0;
            return data;
        }
