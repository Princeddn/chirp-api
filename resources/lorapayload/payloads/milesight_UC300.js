/**
 * 
 * https://github.com/Milesight-IoT/SensorDecoders/blob/main/UC_Series/UC300/UC300_Decoder.js
 * Payload Decoder
 *
...
function milesightDeviceDecode(bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // GPIO INPUT
            ...
            decoded[gpio_in_name] = bytes[i] === 0 ? 0 : 1;
            i += 1;
        }
        // GPIO OUTPUT
            ...
            decoded[gpio_out_name] = bytes[i] === 0 ? 0 : 1;
            i += 1;
        }
        // GPIO AS COUNTER
