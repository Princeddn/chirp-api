/**
 * 
 * https://github.com/Milesight-IoT/SensorDecoders/blob/main/EM_Series/EM300_Series/EM300-MCS/EM300-MCS_Decoder.js
 * Payload Decoder
 *
...
function milesightDeviceDecode(bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // MAGNET STATUS
            ...
            decoded.magnet_status = bytes[i] === 0 ? "0" : "1";
            i += 1;
        }
        // TEMPERATURE、HUMIDITY & MAGNET STATUS HISTROY
            ...
            point.magnet_status = bytes[i + 7] === 0 ? "close" : "open";
