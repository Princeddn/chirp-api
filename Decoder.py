...
# Mock logging to avoid errors if plugins use it
class MockLogger:
...
# We'll rely on the plugins importing logging. If they do generic logging.debug, it goes to root.
# we can configure root logger to be quiet.

# --- GENERATED DECODERS BELOW ---
...
class UnifiedDecoder:
    ...
    def decode_uplink(self, payload_hex, deveui=None):
        ...
        if driver:
            try:
                # jeedom parse returns 'data' dict which has 'parsed' key
